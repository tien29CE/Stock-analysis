...
label = ['AAA','AAM','AAT','ABR','ABS','ABT','ACB','ACC','ACL','ADG','ADS','AGG','AGM','AGR','AMD','ANV','APC','APC','APG','APH','ASG','ASG'
...
,'DQC','DRC','DRH','DRL','DSN','DTA','DTL','DTT','DVP','DXG','DXS','DXV','EIB','ELC','EMC','EVE','EVF','EVG','FMC','FMC','FPT','FRT','FTS'
,'GAB','GAS','GDT','GEG','GEX','GIL','GMD','GSP','GTA','GVR','HAG','HAH','HAI','HAP','HAR','HAS','HAX','HBC','HCD','HCM','HDB','HDC','HDG'
,'HHP','HHS','HID','HII','HMC','HNG','HOT','HPG','HPX','HQC','HRC','HSG','HSL','HT1','HTI','HTL','HTN','HTV','HU1','HU3','HUB','HVB','HVH'
,'HVX','IBC','ICT','IDI','IJC','ILB','IMP','ITA','ITC','ITD','JVC','KBC','KDC','KHG','KHP','KMR','KOS','KPF','KSB','L10','LAF','LBM','LCG'
,'LDG','LGL','LHG','LIX','LM8','LPB','LSS','MBB','MCG','MCP','MDG','MHC','MIG','MSB','MSH','MSN','MWG','NAF','NAV','NAV','NCT','NHA','NHH'
...
,'VOS','VPB','VPD','VPH','VPI','VPS','VRC','VRE','VSC','VSH','VSI','VTB','VTO','YBM','YEG']
for name in label:
    print(f"{name} = pd.read_excel('stock data\{name} Historical Data.xlsx')")